...
export default function NGODashboard({ user }) {
  ...
  const handleTrackImpact = async () => {
    try {
      ...
      alert(`Your NGO impact: ${impactData.impact || 'No data available'}`);
    } catch (err) {
  ...
  return (
    <div style={styles.container}>
      <div style={styles.header}>
        ...
        <p>NGO Dashboard - Choose your action</p>
      </div>
      ...
      <div style={styles.optionsGrid}>
        ...
        <div style={styles.optionCard} onClick={handleTrackImpact}>
          ...
          <p style={styles.optionDescription}>
            Monitor your NGO's contribution to food waste reduction and see your environmental impact
          </p>
          <button 
            style={{
              ...styles.optionButton,
